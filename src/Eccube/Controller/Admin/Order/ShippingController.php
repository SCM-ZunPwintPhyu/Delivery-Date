...
class ShippingController extends AbstractController
{
     ...
     * 出荷登録/編集画面.
     *
     * @Route("/%eccube_admin_route%/shipping/{id}/edit", name="admin_shipping_edit")
    ...
    /**
     * @Route("/%eccube_admin_route%/shipping/preview_notify_mail/{id}", name="admin_shipping_preview_notify_mail")
     *
    ...
    /**
     * @Route("/%eccube_admin_route%/shipping/notify_mail/{id}", name="admin_shipping_notify_mail", methods={"PUT"})
     *
     * @param Shipping $Shipping
     *
     * @return JsonResponse
