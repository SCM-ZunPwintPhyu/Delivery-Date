...
class ShippingType extends AbstractType
{
     ...
     */
    public function __construct(EccubeConfig $eccubeConfig, DeliveryRepository $deliveryRepository, DeliveryFeeRepository $deliveryFeeRepository,CalendarRepository $calendarRepository)
    {
