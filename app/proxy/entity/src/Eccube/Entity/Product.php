 ...
 * @UniqueEntity({"id"})
 * @EntityReplace("Eccube\Entity\Product")
 */
class Product extends \Eccube\Entity\AbstractEntity
{
     ...
     * @var int
     *
     * @ORM\Column(name="desire_delivery_date", type="integer", options={"unsigned":true,"default"=0})
     */
    ...
    /**
     * Set DesireDeliveryDate.
     *
     * @param integer $desireDeliveryDate
     *
     * @return Product
     */
    public function setDesireDeliveryDate($desireDeliveryDate)
    {
        $this->desire_delivery_date = $desireDeliveryDate;

        return $this;
    }

    /**
     * Get DesireDeliveryDate.
     *
     * @return integer
     */
